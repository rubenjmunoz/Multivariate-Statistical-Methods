...
t > c
```
We REJECT the null hypothesis at 5% significance level that there is NO association between the groups of variables. The test statistic `r t` is GREATER than the critical value `r c`.
