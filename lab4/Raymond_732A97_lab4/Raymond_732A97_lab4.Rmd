...
S <- as.matrix(read.table("P10-16.dat")); S
R <- cov2cor(S); kable(R)
...
Because in this case the correlation matrix was used, $U$ and $V$ are the canonical variates and they are expressed as $U = aX$ and $V = bX$ where $X$ is the variables and $a$ and $b$ are the vectors of the coefficients of the linear combinations of the variates that summarise the correlation between the variables.
