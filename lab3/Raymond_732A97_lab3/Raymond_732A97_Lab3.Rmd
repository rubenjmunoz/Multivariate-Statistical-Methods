...
```{r}
S <- cov(trackrcs[,-1])
R <- cor(trackrcs[,-1]); kable(R, digits = 3)
eigen(R)$values
...
It seems the first principal component is a meausure of how much less time the athletes of a particular nation take to complete a race relative to their other fellow competitiors from other nations. We can notice that athletes generally concentrate a lot of efforts in running very fast so that they complete their races in the shortest times possible in the 100 metre races and the marathon.
